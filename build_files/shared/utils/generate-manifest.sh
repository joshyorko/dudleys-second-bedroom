...
echo "[dudley-versioning] ========================================"
echo "[dudley-versioning] Build Manifest Generation"
echo "[dudley-versioning] ========================================"
...
echo "[dudley-versioning] Image: $IMAGE_NAME"
echo "[dudley-versioning] Base: $BASE_IMAGE"
echo "[dudley-versioning] Commit: $GIT_COMMIT"
echo "[dudley-versioning]"

# Initialize manifest
echo "[dudley-versioning] Initializing manifest..."
manifest=$(init_manifest "$IMAGE_NAME" "$BASE_IMAGE" "$GIT_COMMIT")

# Compute hash for wallpaper hook
echo "[dudley-versioning] Computing hash for wallpaper hook..."
WALLPAPER_DEPS=(
...
echo "[dudley-versioning]   Version: $wallpaper_hash (${#WALLPAPER_DEPS[@]} files, $WALLPAPER_COUNT wallpapers)"
...
echo "[dudley-versioning] Computing hash for vscode-extensions hook..."
VSCODE_DEPS=(
...
echo "[dudley-versioning]   Version: $vscode_hash ($extension_count extensions)"
...
echo "[dudley-versioning] Computing hash for welcome hook..."
